  ...
  <div class="fixed bottom-0 left-0 bg-white p-5 pb-4 text-left align-top w-full h-16">
    <div class="relative">
      ...
      <div class="float-left w-7 h-7 leading-3">
        <button id="player-play-button" type="button" @click.prevent="toggleAudio">
      ...
      <div class="float-left w-7 h-7 leading-3 ml-7 mt-2 player-scrub">
        ...
        mx-auto player-song-info" v-if="currentSong.modified_name">
          ...
          <span class="song-artist">(uploaded {{currentSong.display_name}})</span>
        </div>
        <span class="block w-full h-2 rounded m-1 mt-2 bg-gray-200
        relative cursor-pointer" @click.prevent="updateSeek">
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      durattion: (state) => state.player.durattion,
